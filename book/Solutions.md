...
```vhdl
-- 16-Register File (32-bit) with 2 independent read ports
entity RegFile32 is
  port(
    clk   : in bit;
    we    : in bit;
...
```vhdl
-- 32-bit Instruction Decoder (A32-Lite)
entity Decoder32 is
  port(
...
```vhdl
-- Full Condition Checker (16 ARM conditions)
